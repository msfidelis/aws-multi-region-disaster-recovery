...
resource "aws_appautoscaling_target" "idempotecy_read" {
...
resource "aws_appautoscaling_policy" "idempotecy_read" {

  provider = aws.primary

  name               = format("%s-autoscaling-read", aws_dynamodb_table.idempotency.id)
  policy_type        = "TargetTrackingScaling"
  resource_id        = aws_appautoscaling_target.idempotecy_read.resource_id
  scalable_dimension = aws_appautoscaling_target.idempotecy_read.scalable_dimension
  service_namespace  = aws_appautoscaling_target.idempotecy_read.service_namespace
...
resource "aws_appautoscaling_target" "idempotecy_write" {
...
resource "aws_appautoscaling_policy" "idempotecy_write" {

  provider = aws.primary

  name               = format("%s-autoscaling-write", aws_dynamodb_table.idempotency.id)
  policy_type        = "TargetTrackingScaling"
  resource_id        = aws_appautoscaling_target.idempotecy_write.resource_id
  scalable_dimension = aws_appautoscaling_target.idempotecy_write.scalable_dimension
  service_namespace  = aws_appautoscaling_target.idempotecy_write.service_namespace
...
resource "aws_dynamodb_table_replica" "idempotency" {
  ...
  depends_on = [
    aws_appautoscaling_target.idempotecy_read,
    aws_appautoscaling_target.idempotecy_write,
    aws_appautoscaling_policy.idempotecy_read,
    aws_appautoscaling_policy.idempotecy_write
  ]
